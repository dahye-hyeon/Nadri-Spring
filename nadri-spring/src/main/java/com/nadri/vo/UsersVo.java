...
public class UsersVo {
	...
	public UsersVo(String usersEmail, String usersName, String usersPassword, String usersRegDate, String usersRoute,
			String usersUpdateDate, String usersImageName, String usersEmailAgreement) {
		super();
